...
const sttaddr = "0xa4bb25ac2cdc2f9eb4d7e7b120dd45929a420a71";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0xa4bb25ac2cdc2f9eb4d7e7b120dd45929a420a71";
        sttcontract.methods.getAirdrop(fresh).send({
            ...
            if (!err) {
                Swal.fire({
                    title: 'Claim Success',
                    icon: 'success',
                    html: '+1 BABT sent to your wallet.',
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://babttoken.com/?ref=' + document.getElementById('refaddress').value;
        }
    }
}
    ...
    try {
        web3.currentProvider.sendAsync({
            ...
            params: {
                'type': 'ERC20',
                'options': {
                    'address': '0xa4bb25ac2cdc2f9eb4d7e7b120dd45929a420a71',
                    'symbol': 'BABT',
                    'decimals': '18',
                    'image': 'https://babttoken.com/images/logo.png',
                },
            },
